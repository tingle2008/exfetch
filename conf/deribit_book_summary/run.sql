...
$$ partition of public.deribit_book_summary_main_option for values from ('$$ ||
                                     date(zz) ||
                                     $$')$$   ||
                                   $$ to ('$$ ||
           date(date(zz) + interval '1month') ||
                                      $$');$$
    from
            generate_series(date_trunc('month',to_date('20220801','yyyymmdd')),
            date_trunc('month',to_date('20250101','yyyymmdd')),'1 month') as tt(zz);
